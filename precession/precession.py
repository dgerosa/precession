...
def kappadiscriminant_coefficients(u,xi,q,chi1,chi2):
    ...
    + ( -48 * ( S2 )**( 2 ) * ( u )**( 2 ) + ( 8 * ( q )**( 4 ) * ( -1 + \
    4 * ( S2 )**( 2 ) * ( u )**( 2 ) ) + ( -2 * q * ( 9 + ( 40 * ( S2 \
    )**( 2 ) * ( u )**( 2 ) + -20 * u * xi ) ) + ( 4 * ( q )**( 3 ) * ( \
    -9 + ( 20 * ( S2 )**( 2 ) * ( u )**( 2 ) + -16 * u * xi ) ) + ( q \
    )**( 2 ) * ( -47 + ( 16 * ( S2 )**( 2 ) * ( u )**( 2 ) + ( -24 * u * \
    xi + 16 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) ) ) + ( ( ( ( 1 + \
    q ) * ( S2 )**( 2 ) * u + q * xi ) )**( 2 ) * ( 16 * ( ( -1 + q ) \
    )**( 3 ) * ( ( 1 + q ) )**( 4 ) * ( S2 )**( 6 ) * ( u )**( 4 ) + ( ( \
    q )**( 2 ) * ( xi )**( 2 ) * ( 1 + ( ( q )**( 4 ) + ( 8 * q * u * xi \
    + ( 8 * ( q )**( 3 ) * u * xi + 2 * ( q )**( 2 ) * ( -1 + ( 8 * u * \
    xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) + ( ( ( -1 + ( q \
    )**( 2 ) ) )**( 2 ) * ( S2 )**( 4 ) * ( u )**( 2 ) * ( -8 + ( ( q \
    )**( 4 ) + ( 2 * ( q )**( 3 ) * ( -9 + 4 * u * xi ) + ( -4 * q * ( 9 \
    + 8 * u * xi ) + ( q )**( 2 ) * ( -47 + ( -24 * u * xi + 16 * ( u \
    )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) + -1 * ( -1 + ( q )**( 2 ) ) * ( \
    S2 )**( 2 ) * ( -1 + ( ( q )**( 6 ) + ( -8 * q * u * xi + ( 10 * ( q \
    )**( 5 ) * u * xi + ( ( q )**( 2 ) * ( 3 + ( -18 * u * xi + -8 * ( u \
    )**( 2 ) * ( xi )**( 2 ) ) ) + ( 2 * ( q )**( 3 ) * u * xi * ( -1 + ( \
    12 * u * xi + 16 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( q )**( 4 ) * \
    ( -3 + ( 18 * u * xi + 32 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) \
    ) ) ) ) ) + ( -1 * ( -1 + q ) * q * ( ( 1 + q ) )**( 3 ) * ( S1 )**( \
    6 ) * ( u )**( 2 ) * ( 4 * ( S2 )**( 2 ) * ( u )**( 2 ) * ( -5 + 12 * \
    ( S2 )**( 2 ) * ( u )**( 2 ) ) + ( ( q )**( 7 ) * ( 1 + ( -32 * ( S2 \
    )**( 2 ) * ( u )**( 2 ) + 16 * ( S2 )**( 4 ) * ( u )**( 4 ) ) ) + ( q \
    * ( -1 + ( 144 * ( S2 )**( 4 ) * ( u )**( 4 ) + ( 2 * u * xi + 4 * ( \
    S2 )**( 2 ) * ( u )**( 2 ) * ( 17 + -2 * u * xi ) ) ) ) + ( 4 * ( q \
    )**( 6 ) * u * ( 28 * ( S2 )**( 4 ) * ( u )**( 3 ) + ( 6 * xi + -1 * \
    ( S2 )**( 2 ) * u * ( 13 + 24 * u * xi ) ) ) + ( ( q )**( 3 ) * ( 3 + \
    ( -272 * ( S2 )**( 4 ) * ( u )**( 4 ) + ( -76 * u * xi + ( -112 * ( u \
    )**( 2 ) * ( xi )**( 2 ) + ( 32 * ( u )**( 3 ) * ( xi )**( 3 ) + -16 \
    * ( S2 )**( 2 ) * ( u )**( 2 ) * ( -3 + ( -7 * u * xi + 2 * ( u )**( \
    2 ) * ( xi )**( 2 ) ) ) ) ) ) ) ) + ( ( q )**( 5 ) * ( -3 + ( 112 * ( \
    S2 )**( 4 ) * ( u )**( 4 ) + ( 74 * u * xi + ( 88 * ( u )**( 2 ) * ( \
    xi )**( 2 ) + 4 * ( S2 )**( 2 ) * ( u )**( 2 ) * ( -21 + ( -26 * u * \
    xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) + ( -4 * ( q )**( 4 \
    ) * u * ( 44 * ( S2 )**( 4 ) * ( u )**( 3 ) + ( ( S2 )**( 2 ) * u * ( \
    33 + ( -24 * u * xi + -8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + 2 * xi \
    * ( -3 + ( 7 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) + 4 \
    * ( q )**( 2 ) * u * ( 4 * ( S2 )**( 4 ) * ( u )**( 3 ) + ( 4 * xi * \
    ( -3 + 2 * u * xi ) + ( S2 )**( 2 ) * ( 51 * u + -8 * ( u )**( 3 ) * \
    ( xi )**( 2 ) ) ) ) ) ) ) ) ) ) ) + ( -1 * ( ( 1 + q ) )**( 2 ) * ( \
    S1 )**( 4 ) * u * ( -16 * ( ( -1 + q ) )**( 3 ) * ( ( 1 + q ) )**( 4 \
    ) * ( 1 + ( 6 * q + 3 * ( q )**( 2 ) ) ) * ( S2 )**( 6 ) * ( u )**( 5 \
    ) + ( 2 * ( ( -1 + ( q )**( 2 ) ) )**( 2 ) * ( S2 )**( 4 ) * ( u )**( \
    3 ) * ( 4 + ( 4 * ( q )**( 6 ) + ( 2 * q * ( 7 + 8 * u * xi ) + ( 2 * \
    ( q )**( 5 ) * ( 7 + 8 * u * xi ) + ( ( q )**( 3 ) * ( 134 + ( 40 * u \
    * xi + -32 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( ( q )**( 2 ) * ( 77 \
    + ( 36 * u * xi + -8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( q )**( 4 \
    ) * ( 77 + ( 36 * u * xi + -8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) \
    ) ) ) ) + ( -1 * ( -1 + ( q )**( 2 ) ) * ( S2 )**( 2 ) * u * ( 1 + ( \
    10 * ( q )**( 8 ) + ( 8 * q * ( -3 + u * xi ) + ( 8 * ( q )**( 7 ) * \
    ( 3 + 8 * u * xi ) + ( ( q )**( 2 ) * ( -13 + ( -50 * u * xi + 8 * ( \
    u )**( 2 ) * ( xi )**( 2 ) ) ) + ( ( q )**( 6 ) * ( -31 + ( 22 * u * \
    xi + 64 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( -24 * ( q )**( 5 ) * ( \
    3 + ( 2 * u * xi + ( 2 * ( u )**( 2 ) * ( xi )**( 2 ) + 4 * ( u )**( \
    3 ) * ( xi )**( 3 ) ) ) ) + ( -8 * ( q )**( 3 ) * ( -9 + ( 3 * u * xi \
    + ( 3 * ( u )**( 2 ) * ( xi )**( 2 ) + 4 * ( u )**( 3 ) * ( xi )**( 3 \
    ) ) ) ) + ( q )**( 4 ) * ( 33 + ( 28 * u * xi + ( -144 * ( u )**( 2 ) \
    * ( xi )**( 2 ) + 32 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) ) ) ) ) ) ) \
    ) ) + ( q )**( 2 ) * xi * ( 2 + ( 2 * ( q )**( 7 ) + ( -1 * u * xi + \
    ( ( q )**( 6 ) * ( -2 + 23 * u * xi ) + ( q * ( -2 + ( 40 * u * xi + \
    -8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( ( q )**( 5 ) * ( -6 + ( 40 \
    * u * xi + 40 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( ( q )**( 2 ) * ( \
    -6 + ( 25 * u * xi + ( 104 * ( u )**( 2 ) * ( xi )**( 2 ) + -16 * ( u \
    )**( 3 ) * ( xi )**( 3 ) ) ) ) + ( ( q )**( 3 ) * ( 6 + ( -80 * u * \
    xi + ( -48 * ( u )**( 2 ) * ( xi )**( 2 ) + 96 * ( u )**( 3 ) * ( xi \
    )**( 3 ) ) ) ) + -1 * ( q )**( 4 ) * ( -6 + ( 47 * u * xi + ( 120 * ( \
    u )**( 2 ) * ( xi )**( 2 ) + 96 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) \
    ) ) ) ) ) ) ) ) ) ) ) + -1 * ( 1 + q ) * ( S1 )**( 2 ) * ( 16 * ( ( \
    -1 + q ) )**( 3 ) * ( ( 1 + q ) )**( 5 ) * ( 2 + 3 * q ) * ( S2 )**( \
    8 ) * ( u )**( 6 ) + ( 4 * ( ( -1 + q ) )**( 2 ) * ( ( 1 + q ) )**( 4 \
    ) * ( S2 )**( 6 ) * ( u )**( 4 ) * ( -8 + ( 5 * ( q )**( 4 ) + ( 2 * \
    ( q )**( 3 ) * ( -11 + u * xi ) + ( -1 * q * ( 5 + 24 * u * xi ) + ( \
    q )**( 2 ) * ( -24 + ( -2 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) \
    ) ) ) ) ) ) + ( ( -1 + q ) * ( ( 1 + q ) )**( 2 ) * ( S2 )**( 4 ) * ( \
    u )**( 2 ) * ( 10 + ( ( q )**( 8 ) + ( 8 * ( q )**( 7 ) * ( -3 + u * \
    xi ) + ( 8 * q * ( 3 + 8 * u * xi ) + ( ( q )**( 6 ) * ( -13 + ( -50 \
    * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( ( q )**( 2 ) * ( \
    -31 + ( 22 * u * xi + 64 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( -24 * \
    ( q )**( 3 ) * ( 3 + ( 2 * u * xi + ( 2 * ( u )**( 2 ) * ( xi )**( 2 \
    ) + 4 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) + ( -8 * ( q )**( 5 ) * ( \
    -9 + ( 3 * u * xi + ( 3 * ( u )**( 2 ) * ( xi )**( 2 ) + 4 * ( u )**( \
    3 ) * ( xi )**( 3 ) ) ) ) + ( q )**( 4 ) * ( 33 + ( 28 * u * xi + ( \
    -144 * ( u )**( 2 ) * ( xi )**( 2 ) + 32 * ( u )**( 3 ) * ( xi )**( 3 \
    ) ) ) ) ) ) ) ) ) ) ) ) + ( ( q )**( 2 ) * ( xi )**( 2 ) * ( 1 + ( ( \
    q )**( 7 ) + ( ( q )**( 6 ) * ( -1 + 6 * u * xi ) + ( q * ( -1 + 10 * \
    u * xi ) + ( ( q )**( 5 ) * ( -3 + ( 10 * u * xi + -8 * ( u )**( 2 ) \
    * ( xi )**( 2 ) ) ) + ( ( q )**( 2 ) * ( -3 + ( 6 * u * xi + 32 * ( u \
    )**( 2 ) * ( xi )**( 2 ) ) ) + ( ( q )**( 3 ) * ( 3 + ( -20 * u * xi \
    + ( -24 * ( u )**( 2 ) * ( xi )**( 2 ) + 32 * ( u )**( 3 ) * ( xi \
    )**( 3 ) ) ) ) + -1 * ( q )**( 4 ) * ( -3 + ( 12 * u * xi + ( 64 * ( \
    u )**( 2 ) * ( xi )**( 2 ) + 64 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) \
    ) ) ) ) ) ) ) + -1 * ( 1 + q ) * ( S2 )**( 2 ) * ( 1 + ( ( q )**( 10 \
    ) + ( 2 * q * ( -1 + 5 * u * xi ) + ( 2 * ( q )**( 9 ) * ( -1 + 5 * u \
    * xi ) + ( ( q )**( 2 ) * ( -3 + 22 * ( u )**( 2 ) * ( xi )**( 2 ) ) \
    + ( ( q )**( 8 ) * ( -3 + 22 * ( u )**( 2 ) * ( xi )**( 2 ) ) + ( -8 \
    * ( q )**( 3 ) * ( -1 + ( 5 * u * xi + ( 6 * ( u )**( 2 ) * ( xi )**( \
    2 ) + 4 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) + ( -8 * ( q )**( 7 ) * \
    ( -1 + ( 5 * u * xi + ( 6 * ( u )**( 2 ) * ( xi )**( 2 ) + 4 * ( u \
    )**( 3 ) * ( xi )**( 3 ) ) ) ) + ( 4 * ( q )**( 5 ) * ( -3 + ( 15 * u \
    * xi + ( 24 * ( u )**( 2 ) * ( xi )**( 2 ) + ( 8 * ( u )**( 3 ) * ( \
    xi )**( 3 ) + 40 * ( u )**( 4 ) * ( xi )**( 4 ) ) ) ) ) + ( -2 * ( q \
    )**( 4 ) * ( -1 + ( 11 * ( u )**( 2 ) * ( xi )**( 2 ) + ( 8 * ( u \
    )**( 3 ) * ( xi )**( 3 ) + 48 * ( u )**( 4 ) * ( xi )**( 4 ) ) ) ) + \
    -2 * ( q )**( 6 ) * ( -1 + ( 11 * ( u )**( 2 ) * ( xi )**( 2 ) + ( 8 \
    * ( u )**( 3 ) * ( xi )**( 3 ) + 48 * ( u )**( 4 ) * ( xi )**( 4 ) ) \
    ...
    ( S1 )**( 6 ) * ( u )**( 5 ) + ( ( S2 )**( 4 ) * ( 30 * ( u )**( 3 ) \
    + -72 * ( S1 )**( 2 ) * ( u )**( 5 ) ) + ( xi + ( 16 * ( S1 )**( 2 ) \
    * ( u )**( 2 ) * xi + ( 2 * ( S1 )**( 4 ) * ( u )**( 3 ) * ( 23 + 24 \
    * u * xi ) + 4 * ( S2 )**( 2 ) * u * ( -3 + ( 4 * ( S1 )**( 4 ) * ( u \
    )**( 4 ) + ( 2 * u * xi + ( S1 )**( 2 ) * ( u )**( 2 ) * ( 13 + 8 * u \
    * xi ) ) ) ) ) ) ) ) ) + ( q * ( S2 )**( 2 ) * ( -8 * ( S2 )**( 6 ) * \
    ( u )**( 5 ) + ( ( S1 )**( 4 ) * ( 30 * ( u )**( 3 ) + -72 * ( S2 \
    )**( 2 ) * ( u )**( 5 ) ) + ( xi + ( 16 * ( S2 )**( 2 ) * ( u )**( 2 \
    ) * xi + ( 2 * ( S2 )**( 4 ) * ( u )**( 3 ) * ( 23 + 24 * u * xi ) + \
    4 * ( S1 )**( 2 ) * u * ( -3 + ( 4 * ( S2 )**( 4 ) * ( u )**( 4 ) + ( \
    2 * u * xi + ( S2 )**( 2 ) * ( u )**( 2 ) * ( 13 + 8 * u * xi ) ) ) ) \
    ) ) ) ) ) + ( ( q )**( 8 ) * ( -96 * ( S1 )**( 8 ) * ( u )**( 5 ) + ( \
    2 * ( S1 )**( 6 ) * ( u )**( 3 ) * ( 25 + ( 24 * ( S2 )**( 2 ) * ( u \
    )**( 2 ) + ( -10 * u * xi + -8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) + \
    ( ( S2 )**( 2 ) * ( -2 * ( S2 )**( 4 ) * ( u )**( 3 ) + ( xi + ( -1 * \
    u * ( xi )**( 2 ) + ( S2 )**( 2 ) * ( u + -3 * ( u )**( 2 ) * xi ) ) \
    ) ) + ( ( S1 )**( 4 ) * u * ( -4 + ( -144 * ( S2 )**( 4 ) * ( u )**( \
    4 ) + ( 65 * u * xi + ( 40 * ( u )**( 2 ) * ( xi )**( 2 ) + -2 * ( S2 \
    )**( 2 ) * ( u )**( 2 ) * ( 23 + ( -4 * u * xi + 8 * ( u )**( 2 ) * ( \
    xi )**( 2 ) ) ) ) ) ) ) + ( S1 )**( 2 ) * ( 96 * ( S2 )**( 6 ) * ( u \
    )**( 5 ) + ( 2 * ( S2 )**( 4 ) * ( u )**( 3 ) * ( -25 + 6 * u * xi ) \
    + ( xi * ( -1 + 7 * u * xi ) + ( S2 )**( 2 ) * u * ( -3 + ( 2 * u * \
    xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) ) ) ) + ( ( q )**( \
    2 ) * ( ( S1 )**( 6 ) * ( -2 * ( u )**( 3 ) + 96 * ( S2 )**( 2 ) * ( \
    u )**( 5 ) ) + ( ( S1 )**( 4 ) * ( u + ( -50 * ( S2 )**( 2 ) * ( u \
    )**( 3 ) + ( -144 * ( S2 )**( 4 ) * ( u )**( 5 ) + ( -3 * ( u )**( 2 \
    ) * xi + 12 * ( S2 )**( 2 ) * ( u )**( 4 ) * xi ) ) ) ) + ( ( S1 )**( \
    2 ) * ( 48 * ( S2 )**( 6 ) * ( u )**( 5 ) + ( xi + ( -1 * u * ( xi \
    )**( 2 ) + ( -2 * ( S2 )**( 4 ) * ( u )**( 3 ) * ( 23 + ( -4 * u * xi \
    + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( S2 )**( 2 ) * u * ( -3 + ( \
    2 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) + -1 * ( S2 \
    )**( 2 ) * ( 96 * ( S2 )**( 6 ) * ( u )**( 5 ) + ( xi + ( -7 * u * ( \
    xi )**( 2 ) + ( ( S2 )**( 2 ) * u * ( 4 + ( -65 * u * xi + -40 * ( u \
    )**( 2 ) * ( xi )**( 2 ) ) ) + 2 * ( S2 )**( 4 ) * ( u )**( 3 ) * ( \
    -25 + ( 10 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) ) \
    ) ) + ( -1 * ( q )**( 3 ) * ( 40 * ( S1 )**( 8 ) * ( u )**( 5 ) + ( \
    24 * ( S2 )**( 8 ) * ( u )**( 5 ) + ( ( xi )**( 3 ) + ( -2 * ( S1 \
    )**( 6 ) * ( u )**( 3 ) * ( 13 + ( 88 * ( S2 )**( 2 ) * ( u )**( 2 ) \
    + -40 * u * xi ) ) + ( 3 * ( S2 )**( 2 ) * xi * ( 1 + -6 * u * xi ) + \
    ( 2 * ( S2 )**( 6 ) * ( u )**( 3 ) * ( 33 + ( 76 * u * xi + -8 * ( u \
    )**( 2 ) * ( xi )**( 2 ) ) ) + ( 2 * ( S2 )**( 4 ) * ( u )**( 2 ) * \
    xi * ( -7 + ( 32 * u * xi + 24 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( \
    -2 * ( S1 )**( 4 ) * ( u )**( 2 ) * ( xi * ( 23 + -24 * u * xi ) + ( \
    S2 )**( 2 ) * u * ( -107 + ( 12 * u * xi + 24 * ( u )**( 2 ) * ( xi \
    )**( 2 ) ) ) ) + ( S1 )**( 2 ) * ( -144 * ( S2 )**( 6 ) * ( u )**( 5 \
    ) + ( 2 * ( S2 )**( 4 ) * ( u )**( 3 ) * ( 129 + 56 * u * xi ) + ( xi \
    * ( 1 + ( -18 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + 4 * ( \
    S2 )**( 2 ) * u * ( -12 + ( 7 * u * xi + ( 12 * ( u )**( 2 ) * ( xi \
    )**( 2 ) + 8 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) ) ) ) ) ) ) ) ) ) ) \
    ) + ( -1 * ( q )**( 7 ) * ( 24 * ( S1 )**( 8 ) * ( u )**( 5 ) + ( 40 \
    * ( S2 )**( 8 ) * ( u )**( 5 ) + ( ( xi )**( 3 ) + ( 2 * ( S2 )**( 4 \
    ) * ( u )**( 2 ) * xi * ( -23 + 24 * u * xi ) + ( 2 * ( S2 )**( 6 ) * \
    ( u )**( 3 ) * ( -13 + 40 * u * xi ) + ( -2 * ( S1 )**( 6 ) * ( u \
    )**( 3 ) * ( -33 + ( 72 * ( S2 )**( 2 ) * ( u )**( 2 ) + ( -76 * u * \
    xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) + ( ( S2 )**( 2 ) * xi * \
    ( 1 + ( -18 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( 2 * ( \
    S1 )**( 4 ) * ( u )**( 2 ) * ( ( S2 )**( 2 ) * u * ( 129 + 56 * u * \
    xi ) + xi * ( -7 + ( 32 * u * xi + 24 * ( u )**( 2 ) * ( xi )**( 2 ) \
    ) ) ) + ( S1 )**( 2 ) * ( -176 * ( S2 )**( 6 ) * ( u )**( 5 ) + ( 3 * \
    xi * ( 1 + -6 * u * xi ) + ( -2 * ( S2 )**( 4 ) * ( u )**( 3 ) * ( \
    -107 + ( 12 * u * xi + 24 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + 4 * ( \
    S2 )**( 2 ) * u * ( -12 + ( 7 * u * xi + ( 12 * ( u )**( 2 ) * ( xi \
    )**( 2 ) + 8 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) ) ) ) ) ) ) ) ) ) ) \
    ) + ( ( q )**( 4 ) * ( -64 * ( S1 )**( 8 ) * ( u )**( 5 ) + ( 144 * ( \
    S2 )**( 8 ) * ( u )**( 5 ) + ( -8 * u * ( xi )**( 4 ) + ( -2 * ( S1 \
    )**( 6 ) * ( u )**( 3 ) * ( -35 + ( 56 * ( S2 )**( 2 ) * ( u )**( 2 ) \
    + ( 22 * u * xi + 16 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) + ( 2 * ( \
    S2 )**( 6 ) * ( u )**( 3 ) * ( -63 + ( 32 * u * xi + 24 * ( u )**( 2 \
    ) * ( xi )**( 2 ) ) ) + ( ( S2 )**( 4 ) * u * ( 6 + ( -133 * u * xi + \
    ( -120 * ( u )**( 2 ) * ( xi )**( 2 ) + 32 * ( u )**( 3 ) * ( xi )**( \
    3 ) ) ) ) + ( -1 * ( S2 )**( 2 ) * xi * ( -3 + ( 15 * u * xi + ( 76 * \
    ( u )**( 2 ) * ( xi )**( 2 ) + 48 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) \
    ) + ( ( S1 )**( 4 ) * u * ( -4 + ( 144 * ( S2 )**( 4 ) * ( u )**( 4 ) \
    + ( 71 * u * xi + ( 32 * ( u )**( 2 ) * ( xi )**( 2 ) + ( -48 * ( u \
    )**( 3 ) * ( xi )**( 3 ) + 2 * ( S2 )**( 2 ) * ( u )**( 2 ) * ( 35 + \
    ( 28 * u * xi + 16 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) ) + ( \
    S1 )**( 2 ) * ( -48 * ( S2 )**( 6 ) * ( u )**( 5 ) + ( -2 * ( S2 )**( \
    4 ) * ( u )**( 3 ) * ( -9 + ( 38 * u * xi + 8 * ( u )**( 2 ) * ( xi \
    )**( 2 ) ) ) + ( xi * ( -3 + ( 9 * u * xi + ( 12 * ( u )**( 2 ) * ( \
    xi )**( 2 ) + -16 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) + 2 * ( S2 \
    )**( 2 ) * u * ( 1 + ( -1 * u * xi + ( 20 * ( u )**( 2 ) * ( xi )**( \
    2 ) + 8 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) + \
    ( ( q )**( 5 ) * ( 72 * ( S1 )**( 8 ) * ( u )**( 5 ) + ( 72 * ( S2 \
    )**( 8 ) * ( u )**( 5 ) + ( -2 * ( S2 )**( 6 ) * ( u )**( 3 ) * ( 3 + \
    ( -92 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( -2 * ( S1 \
    )**( 6 ) * ( u )**( 3 ) * ( 3 + ( 168 * ( S2 )**( 2 ) * ( u )**( 2 ) \
    + ( -92 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) + ( -2 * ( \
    xi )**( 3 ) * ( -1 + ( 12 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) \
    ) ) + ( 4 * ( S2 )**( 4 ) * ( u )**( 2 ) * xi * ( -19 + ( 16 * u * xi \
    + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( ( S2 )**( 2 ) * xi * ( 3 + \
    ( -36 * u * xi + ( -56 * ( u )**( 2 ) * ( xi )**( 2 ) + 16 * ( u )**( \
    3 ) * ( xi )**( 3 ) ) ) ) + ( 2 * ( S1 )**( 4 ) * ( u )**( 2 ) * ( 72 \
    * ( S2 )**( 4 ) * ( u )**( 3 ) + ( ( S2 )**( 2 ) * u * ( 195 + ( 28 * \
    u * xi + -24 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + 2 * xi * ( -19 + ( \
    16 * u * xi + 8 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) + ( S1 )**( 2 \
    ) * ( -336 * ( S2 )**( 6 ) * ( u )**( 5 ) + ( 2 * ( S2 )**( 4 ) * ( u \
    )**( 3 ) * ( 195 + ( 28 * u * xi + -24 * ( u )**( 2 ) * ( xi )**( 2 ) \
    ) ) + ( 8 * ( S2 )**( 2 ) * u * ( -9 + ( 5 * u * xi + ( 24 * ( u )**( \
    2 ) * ( xi )**( 2 ) + 12 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) + xi * \
    ( 3 + ( -36 * u * xi + ( -56 * ( u )**( 2 ) * ( xi )**( 2 ) + 16 * ( \
    u )**( 3 ) * ( xi )**( 3 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) + ( q )**( 6 ) \
    * ( 144 * ( S1 )**( 8 ) * ( u )**( 5 ) + ( -64 * ( S2 )**( 8 ) * ( u \
    )**( 5 ) + ( -8 * u * ( xi )**( 4 ) + ( -2 * ( S2 )**( 6 ) * ( u )**( \
    3 ) * ( -35 + ( 22 * u * xi + 16 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + \
    ( 2 * ( S1 )**( 6 ) * ( u )**( 3 ) * ( -63 + ( -24 * ( S2 )**( 2 ) * \
    ( u )**( 2 ) + ( 32 * u * xi + 24 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) \
    ) + ( ( S2 )**( 4 ) * u * ( -4 + ( 71 * u * xi + ( 32 * ( u )**( 2 ) \
    * ( xi )**( 2 ) + -48 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) + ( ( S2 \
    )**( 2 ) * xi * ( -3 + ( 9 * u * xi + ( 12 * ( u )**( 2 ) * ( xi )**( \
    2 ) + -16 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) + ( ( S1 )**( 4 ) * u \
    * ( 6 + ( 144 * ( S2 )**( 4 ) * ( u )**( 4 ) + ( -133 * u * xi + ( \
    -120 * ( u )**( 2 ) * ( xi )**( 2 ) + ( 32 * ( u )**( 3 ) * ( xi )**( \
    3 ) + -2 * ( S2 )**( 2 ) * ( u )**( 2 ) * ( -9 + ( 38 * u * xi + 8 * \
    ( u )**( 2 ) * ( xi )**( 2 ) ) ) ) ) ) ) ) + ( S1 )**( 2 ) * ( -112 * \
    ( S2 )**( 6 ) * ( u )**( 5 ) + ( 2 * ( S2 )**( 4 ) * ( u )**( 3 ) * ( \
    35 + ( 28 * u * xi + 16 * ( u )**( 2 ) * ( xi )**( 2 ) ) ) + ( 2 * ( \
    S2 )**( 2 ) * u * ( 1 + ( -1 * u * xi + ( 20 * ( u )**( 2 ) * ( xi \
    )**( 2 ) + 8 * ( u )**( 3 ) * ( xi )**( 3 ) ) ) ) + -1 * xi * ( -3 + \
    ...
    * ( q )**( 2 ) * ( ( ( 1 + q ) )**( 6 ) * ( 1 + ( 18 * q + ( q )**( 2 \
    ...
    ( S2 )**( 2 ) + ( ( q )**( 3 ) * ( ( S1 )**( 2 ) + -5 * ( S2 )**( 2 ) \
    ) + ( q * ( -5 * ( S1 )**( 2 ) + ( S2 )**( 2 ) ) + -1 * ( q )**( 2 ) \
    * ( 7 * ( S1 )**( 2 ) + ( 7 * ( S2 )**( 2 ) + ( xi )**( 2 ) ) ) ) ) ) \
    ) ) ) + ( -6 * q * ( ( 1 + q ) )**( 4 ) * ( q * ( ( 1 + q ) )**( 2 ) \
    * ( 1 + ( 8 * q + ( q )**( 2 ) ) ) + ( 48 * ( q )**( 6 ) * ( S1 )**( \
    4 ) * ( u )**( 4 ) + ( 48 * ( S2 )**( 4 ) * ( u )**( 4 ) + ( -96 * ( \
    q )**( 5 ) * ( ( S1 )**( 4 ) + 2 * ( S1 )**( 2 ) * ( S2 )**( 2 ) ) * \
    ( u )**( 4 ) + ( -96 * q * ( 2 * ( S1 )**( 2 ) * ( S2 )**( 2 ) + ( S2 \
    )**( 4 ) ) * ( u )**( 4 ) + ( 2 * q * ( ( 1 + q ) )**( 2 ) * ( 1 + ( \
    18 * q + ( q )**( 2 ) ) ) * u * xi + ( 16 * ( q )**( 2 ) * ( u )**( 4 \
    ) * ( 10 * ( S1 )**( 4 ) + ( -2 * ( S1 )**( 2 ) * ( S2 )**( 2 ) + ( \
    -11 * ( S2 )**( 4 ) + -2 * ( S2 )**( 2 ) * ( xi )**( 2 ) ) ) ) + ( \
    -16 * ( q )**( 4 ) * ( u )**( 4 ) * ( 11 * ( S1 )**( 4 ) + ( -10 * ( \
    S2 )**( 4 ) + 2 * ( S1 )**( 2 ) * ( ( S2 )**( 2 ) + ( xi )**( 2 ) ) ) \
    ) + ( 64 * ( q )**( 3 ) * ( u )**( 4 ) * ( 2 * ( S1 )**( 4 ) + ( ( S2 \
    )**( 2 ) * ( 2 * ( S2 )**( 2 ) + ( xi )**( 2 ) ) + ( S1 )**( 2 ) * ( \
    5 * ( S2 )**( 2 ) + ( xi )**( 2 ) ) ) ) + ( -8 * q * ( u )**( 3 ) * \
    xi * ( ( q )**( 4 ) * ( S1 )**( 2 ) + ( ( S2 )**( 2 ) + ( 4 * ( q \
    )**( 3 ) * ( ( S1 )**( 2 ) + -5 * ( S2 )**( 2 ) ) + ( 4 * q * ( -5 * \
    ( S1 )**( 2 ) + ( S2 )**( 2 ) ) + -1 * ( q )**( 2 ) * ( 17 * ( S1 \
    )**( 2 ) + ( 17 * ( S2 )**( 2 ) + 4 * ( xi )**( 2 ) ) ) ) ) ) ) + -4 \
    * ( u )**( 2 ) * ( 5 * ( q )**( 6 ) * ( S1 )**( 2 ) + ( 5 * ( S2 )**( \
    2 ) + ( -1 * q * ( ( S1 )**( 2 ) + -11 * ( S2 )**( 2 ) ) + ( ( q )**( \
    5 ) * ( 11 * ( S1 )**( 2 ) + -1 * ( S2 )**( 2 ) ) + ( -1 * ( q )**( 2 \
    ) * ( 15 * ( S1 )**( 2 ) + ( 6 * ( S2 )**( 2 ) + 8 * ( xi )**( 2 ) ) \
    ) + ( -1 * ( q )**( 4 ) * ( 6 * ( S1 )**( 2 ) + ( 15 * ( S2 )**( 2 ) \
    + 8 * ( xi )**( 2 ) ) ) + -2 * ( q )**( 3 ) * ( 13 * ( S1 )**( 2 ) + \
    ( 13 * ( S2 )**( 2 ) + 14 * ( xi )**( 2 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) \
    ) ) ) ) + ( ( 1 + q ) )**( 2 ) * ( ( q )**( 2 ) * ( ( 1 + q ) )**( 4 \
    ) * ( 3 + ( 14 * q + 3 * ( q )**( 2 ) ) ) + ( 12 * ( q )**( 2 ) * ( ( \
    1 + q ) )**( 4 ) * ( 1 + ( 8 * q + ( q )**( 2 ) ) ) * u * xi + ( -16 \
    * q * ( ( 1 + q ) )**( 2 ) * ( u )**( 3 ) * xi * ( 4 * ( q )**( 6 ) * \
    ( S1 )**( 2 ) + ( 4 * ( S2 )**( 2 ) + ( ( q )**( 5 ) * ( 22 * ( S1 \
    )**( 2 ) + -3 * ( S2 )**( 2 ) ) + ( q * ( -3 * ( S1 )**( 2 ) + 22 * ( \
    S2 )**( 2 ) ) + ( -2 * ( q )**( 2 ) * ( 17 * ( S1 )**( 2 ) + ( 9 * ( \
    S2 )**( 2 ) + 2 * ( xi )**( 2 ) ) ) + ( -2 * ( q )**( 4 ) * ( 9 * ( \
    S1 )**( 2 ) + ( 17 * ( S2 )**( 2 ) + 2 * ( xi )**( 2 ) ) ) + -1 * ( q \
    )**( 3 ) * ( 67 * ( S1 )**( 2 ) + ( 67 * ( S2 )**( 2 ) + 44 * ( xi \
    )**( 2 ) ) ) ) ) ) ) ) ) + ( -8 * ( ( 1 + q ) )**( 2 ) * ( u )**( 2 ) \
    * ( 13 * ( q )**( 7 ) * ( S1 )**( 2 ) + ( ( q )**( 8 ) * ( S1 )**( 2 \
    ) + ( ( S2 )**( 2 ) + ( 13 * q * ( S2 )**( 2 ) + ( ( q )**( 6 ) * ( \
    14 * ( S1 )**( 2 ) + ( -2 * ( S2 )**( 2 ) + -1 * ( xi )**( 2 ) ) ) + \
    ( -1 * ( q )**( 2 ) * ( 2 * ( S1 )**( 2 ) + ( -14 * ( S2 )**( 2 ) + ( \
    xi )**( 2 ) ) ) + ( -1 * ( q )**( 5 ) * ( 20 * ( S1 )**( 2 ) + ( 17 * \
    ( S2 )**( 2 ) + 26 * ( xi )**( 2 ) ) ) + ( -1 * ( q )**( 3 ) * ( 17 * \
    ( S1 )**( 2 ) + ( 20 * ( S2 )**( 2 ) + 26 * ( xi )**( 2 ) ) ) + -1 * \
    ( q )**( 4 ) * ( 37 * ( S1 )**( 2 ) + ( 37 * ( S2 )**( 2 ) + 72 * ( \
    xi )**( 2 ) ) ) ) ) ) ) ) ) ) ) + ( -16 * ( u )**( 4 ) * ( 4 * ( q \
    )**( 10 ) * ( S1 )**( 4 ) + ( 4 * ( S2 )**( 4 ) + ( 10 * ( q )**( 9 ) \
    * ( 2 * ( S1 )**( 4 ) + 3 * ( S1 )**( 2 ) * ( S2 )**( 2 ) ) + ( 10 * \
    q * ( 3 * ( S1 )**( 2 ) * ( S2 )**( 2 ) + 2 * ( S2 )**( 4 ) ) + ( ( q \
    )**( 2 ) * ( -3 * ( S1 )**( 4 ) + ( 74 * ( S1 )**( 2 ) * ( S2 )**( 2 \
    ) + ( 53 * ( S2 )**( 4 ) + 4 * ( S2 )**( 2 ) * ( xi )**( 2 ) ) ) ) + \
    ( -4 * ( q )**( 3 ) * ( 9 * ( S1 )**( 4 ) + ( -17 * ( S2 )**( 4 ) + ( \
    6 * ( S2 )**( 2 ) * ( xi )**( 2 ) + -2 * ( S1 )**( 2 ) * ( 5 * ( S2 \
    )**( 2 ) + -6 * ( xi )**( 2 ) ) ) ) ) + ( 4 * ( q )**( 7 ) * ( 17 * ( \
    S1 )**( 4 ) + ( 2 * ( S1 )**( 2 ) * ( 5 * ( S2 )**( 2 ) + -3 * ( xi \
    )**( 2 ) ) + -3 * ( S2 )**( 2 ) * ( 3 * ( S2 )**( 2 ) + 4 * ( xi )**( \
    2 ) ) ) ) + ( ( q )**( 8 ) * ( 53 * ( S1 )**( 4 ) + ( -3 * ( S2 )**( \
    4 ) + ( S1 )**( 2 ) * ( 74 * ( S2 )**( 2 ) + 4 * ( xi )**( 2 ) ) ) ) \
    + ( -4 * ( q )**( 5 ) * ( 25 * ( S1 )**( 4 ) + ( 25 * ( S2 )**( 4 ) + \
    ( 36 * ( S2 )**( 2 ) * ( xi )**( 2 ) + ( 8 * ( xi )**( 4 ) + ( S1 \
    )**( 2 ) * ( 11 * ( S2 )**( 2 ) + 36 * ( xi )**( 2 ) ) ) ) ) ) + ( -1 \
    * ( q )**( 4 ) * ( 101 * ( S1 )**( 4 ) + ( ( S2 )**( 4 ) + ( 92 * ( \
    S2 )**( 2 ) * ( xi )**( 2 ) + ( 8 * ( xi )**( 4 ) + 2 * ( S1 )**( 2 ) \
    * ( 13 * ( S2 )**( 2 ) + 64 * ( xi )**( 2 ) ) ) ) ) ) + -1 * ( q )**( \
    6 ) * ( ( S1 )**( 4 ) + ( 101 * ( S2 )**( 4 ) + ( 128 * ( S2 )**( 2 ) \
    * ( xi )**( 2 ) + ( 8 * ( xi )**( 4 ) + ( S1 )**( 2 ) * ( 26 * ( S2 \
    )**( 2 ) + 92 * ( xi )**( 2 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) + ( -64 * \
    q * ( 1 + q ) * ( u )**( 5 ) * xi * ( 4 * ( q )**( 7 ) * ( S1 )**( 4 \
    ) + ( 4 * ( S2 )**( 4 ) + ( ( q )**( 6 ) * ( -11 * ( S1 )**( 4 ) + 3 \
    * ( S1 )**( 2 ) * ( S2 )**( 2 ) ) + ( q * ( 3 * ( S1 )**( 2 ) * ( S2 \
    )**( 2 ) + -11 * ( S2 )**( 4 ) ) + ( ( q )**( 2 ) * ( -30 * ( S1 )**( \
    4 ) + ( 9 * ( S1 )**( 2 ) * ( S2 )**( 2 ) + ( 5 * ( S2 )**( 4 ) + -4 \
    * ( S2 )**( 2 ) * ( xi )**( 2 ) ) ) ) + ( ( q )**( 5 ) * ( 5 * ( S1 \
    )**( 4 ) + ( -30 * ( S2 )**( 4 ) + ( S1 )**( 2 ) * ( 9 * ( S2 )**( 2 \
    ) + -4 * ( xi )**( 2 ) ) ) ) + ( ( q )**( 3 ) * ( -21 * ( S1 )**( 4 ) \
    + ( 29 * ( S2 )**( 4 ) + ( 4 * ( S2 )**( 2 ) * ( xi )**( 2 ) + 12 * ( \
    S1 )**( 2 ) * ( ( S2 )**( 2 ) + -1 * ( xi )**( 2 ) ) ) ) ) + ( q )**( \
    4 ) * ( 29 * ( S1 )**( 4 ) + ( 4 * ( S1 )**( 2 ) * ( 3 * ( S2 )**( 2 \
    ) + ( xi )**( 2 ) ) + -3 * ( 7 * ( S2 )**( 4 ) + 4 * ( S2 )**( 2 ) * \
    ( xi )**( 2 ) ) ) ) ) ) ) ) ) ) ) + -128 * ( ( 1 + q ) )**( 2 ) * ( u \
    )**( 6 ) * ( ( q )**( 8 ) * ( S1 )**( 6 ) + ( ( S2 )**( 6 ) + ( -1 * \
    ( q )**( 7 ) * ( 7 * ( S1 )**( 6 ) + 9 * ( S1 )**( 4 ) * ( S2 )**( 2 \
    ) ) + ( -1 * q * ( 9 * ( S1 )**( 2 ) * ( S2 )**( 4 ) + 7 * ( S2 )**( \
    6 ) ) + ( ( q )**( 2 ) * ( 18 * ( S1 )**( 4 ) * ( S2 )**( 2 ) + ( 9 * \
    ( S1 )**( 2 ) * ( S2 )**( 4 ) + ( ( S2 )**( 6 ) + -1 * ( S2 )**( 4 ) \
    * ( xi )**( 2 ) ) ) ) + ( ( q )**( 6 ) * ( ( S1 )**( 6 ) + ( 18 * ( \
    S1 )**( 2 ) * ( S2 )**( 4 ) + ( S1 )**( 4 ) * ( 9 * ( S2 )**( 2 ) + \
    -1 * ( xi )**( 2 ) ) ) ) + ( ( q )**( 5 ) * ( 17 * ( S1 )**( 6 ) + ( \
    -10 * ( S2 )**( 6 ) + ( 6 * ( S1 )**( 2 ) * ( S2 )**( 2 ) * ( xi )**( \
    2 ) + ( S1 )**( 4 ) * ( 9 * ( S2 )**( 2 ) + 6 * ( xi )**( 2 ) ) ) ) ) \
    + ( ( q )**( 3 ) * ( -10 * ( S1 )**( 6 ) + ( 17 * ( S2 )**( 6 ) + ( 6 \
    * ( S2 )**( 4 ) * ( xi )**( 2 ) + ( S1 )**( 2 ) * ( 9 * ( S2 )**( 4 ) \
    + 6 * ( S2 )**( 2 ) * ( xi )**( 2 ) ) ) ) ) + -1 * ( q )**( 4 ) * ( 2 \
    * ( S1 )**( 6 ) + ( 3 * ( S1 )**( 4 ) * ( 9 * ( S2 )**( 2 ) + 2 * ( \
    xi )**( 2 ) ) + ( 2 * ( S2 )**( 4 ) * ( ( S2 )**( 2 ) + 3 * ( xi )**( \
    ...
    * ( u )**( 2 ) * ( 3 * ( q )**( 4 ) * ( S1 )**( 2 ) + ( 3 * ( S2 )**( \
    ...
    -1 * ( ( 1 + q ) )**( 4 ) * ( q * ( ( 1 + q ) )**( 2 ) * ( 1 + ( 8 * \
    q + ( q )**( 2 ) ) ) + ( 48 * ( q )**( 6 ) * ( S1 )**( 4 ) * ( u )**( \
    4 ) + ( 48 * ( S2 )**( 4 ) * ( u )**( 4 ) + ( -96 * ( q )**( 5 ) * ( \
    ( S1 )**( 4 ) + 2 * ( S1 )**( 2 ) * ( S2 )**( 2 ) ) * ( u )**( 4 ) + \
    ( -96 * q * ( 2 * ( S1 )**( 2 ) * ( S2 )**( 2 ) + ( S2 )**( 4 ) ) * ( \
    u )**( 4 ) + ( 2 * q * ( ( 1 + q ) )**( 2 ) * ( 1 + ( 18 * q + ( q \
    )**( 2 ) ) ) * u * xi + ( 16 * ( q )**( 2 ) * ( u )**( 4 ) * ( 10 * ( \
    S1 )**( 4 ) + ( -2 * ( S1 )**( 2 ) * ( S2 )**( 2 ) + ( -11 * ( S2 \
    )**( 4 ) + -2 * ( S2 )**( 2 ) * ( xi )**( 2 ) ) ) ) + ( -16 * ( q \
    )**( 4 ) * ( u )**( 4 ) * ( 11 * ( S1 )**( 4 ) + ( -10 * ( S2 )**( 4 \
    ) + 2 * ( S1 )**( 2 ) * ( ( S2 )**( 2 ) + ( xi )**( 2 ) ) ) ) + ( 64 \
    * ( q )**( 3 ) * ( u )**( 4 ) * ( 2 * ( S1 )**( 4 ) + ( ( S2 )**( 2 ) \
    * ( 2 * ( S2 )**( 2 ) + ( xi )**( 2 ) ) + ( S1 )**( 2 ) * ( 5 * ( S2 \
    ...
    S2 )**( 2 ) + 4 * ( xi )**( 2 ) ) ) ) ) ) ) + -4 * ( u )**( 2 ) * ( 5 \
    * ( q )**( 6 ) * ( S1 )**( 2 ) + ( 5 * ( S2 )**( 2 ) + ( -1 * q * ( ( \
    S1 )**( 2 ) + -11 * ( S2 )**( 2 ) ) + ( ( q )**( 5 ) * ( 11 * ( S1 \
    )**( 2 ) + -1 * ( S2 )**( 2 ) ) + ( -1 * ( q )**( 2 ) * ( 15 * ( S1 \
    )**( 2 ) + ( 6 * ( S2 )**( 2 ) + 8 * ( xi )**( 2 ) ) ) + ( -1 * ( q \
    )**( 4 ) * ( 6 * ( S1 )**( 2 ) + ( 15 * ( S2 )**( 2 ) + 8 * ( xi )**( \
