...
#     M,m1,m2,S1,S2=precession.get_fixed(q,chi1,chi2) # Total-mass units M=1
#     ri=1e3*M # Separation. Must be r>10M for PN to be valid
#     rf=10*M    
#     r_vals=[ri,rf]
#     theta1i=numpy.pi/4.
#     theta2i=numpy.pi/4.
#     deltaphii=numpy.pi/4.
#     
#     print theta1i,theta2i,deltaphii
#     
#     # rf -> ri orbit averaged angles
#     theta1f,theta2f,deltaphif=precession.orbit_angles(theta1i,theta2i,deltaphii,r_vals,q,S1,S2)
#     
#     print theta1f[-1],theta2f[-1],deltaphif[-1]
#     xi,J,S=precession.from_the_angles(theta1f[-1],theta2f[-1],deltaphif[-1],q,S1,S2,rf)
#     print xi,J,S 
#     
#     # rf -> ri precession averaged angles
#     theta1f,theta2f,deltaphif=precession.evolve_angles(theta1i,theta2i,deltaphii,r_vals,q,S1,S2)
#     print theta1f[-1],theta2f[-1],deltaphif[-1]
#     xi,J,S=precession.from_the_angles(theta1f[-1],theta2f[-1],deltaphif[-1],q,S1,S2,rf)
#     print xi,J,S 
#     
#     # ri -> rf orb av J
#     xii,Ji,Si=precession.from_the_angles(theta1i,theta2i,deltaphii,q,S1,S2,ri)
#     
#     print "here", xii,Ji,Si,r_vals
#     
#     print precession.J_lim(q,S1,S2,ri)
# 
#     print precession.xi_allowed(Ji,q,S1,S2,ri)
# 
#     print precession.Sb_limits(xii,Ji,q,S1,S2,ri)
# 
#     Jf,xif,Sf=precession.orbit_averaged(xii,Ji,Si,r_vals,q,S1,S2)
#     print Jf,xif,Sf
# 
#     # ri -> rf prec av J (NO S NEEDED!)
